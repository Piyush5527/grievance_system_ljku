...
<template>
    <div>
        <div class="min-h-screen dark:bg-gray-900">
            <nav class=" dark:bg-gray-800 border-b dark:border-gray-700">
                        ...
                        <div class="flex">
                            ...
                            <div class="shrink-0 flex items-center">
                                <Link :href="route('dashboard')">
                                    <ApplicationLogo
                                        class="block h-9 w-auto fill-current dark:text-gray-200"
                                    />
                                </Link>
                            </div>
                ...
                >
                    ...
                    <div class="pt-4 pb-1 border-t dark:border-gray-600">
                        <div class="px-4">
                            <div class="font-medium text-base text-gray-800 dark:text-gray-700">
                                {{ $page.props.auth.user.name }}
                            </div>
